...
var newData = 10;
//adding players deatils through from submit
$('#addteamform').submit(function (e) {
  e.preventDefault();
  let inp_val = $('#inp6').val(); //for slecting specifc team
  let shortName = '';
  ...
  //ading players to local storage
  let addPlayer = {
