...
for (var i = 0; i < playersDetails.length; i++) {
  if (teamFull == playersDetails[i].from) {
    ...
    cnt++;
    // players deatils and puttiong the values into teamMain box
...
`;
  ...
  //opning payer deatils of specific plyer
...
// team table
// the data getting from teamsDeatils can be fill in tabled with help of map fun
console.log(cnt);
